    ...
    <div>
      <div class="flex items-center min-h-screen p-4  lg:justify-center ">
        <div class="flex flex-col overflow-hidden  rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div class="p-4 py-6 text-white bg-black md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
          ...
          <div class="p-5 bg-white md:flex-1">
            ...
            <form class="flex flex-col space-y-5" onSubmit={handleLoginSubmit}>
              ...
              <div>
                <button
                  type="submit"
                  class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-black  rounded-md  focus:ring-blue-200 focus:ring-4"
                >
                  Log in
                </button>
              </div>
